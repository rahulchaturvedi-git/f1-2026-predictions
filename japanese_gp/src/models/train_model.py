...
train_df = df[df["Race"].isin(["Australia", "China", "Miami"])]
# Test on current race
test_df = df[df["Race"] == "Japan"].copy()

if test_df.empty:
    raise ValueError("❌ No data found for Japan in season_dataset.csv. Run merge_dataset.py first.")
